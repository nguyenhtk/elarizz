...
function love.update(dt)
	...
	if
		arrayEqual(inputBuffer, wavuSequence1)
		or arrayEqual(inputBuffer, wavuSequence2 or arrayEqual(inputBuffer, wavuSequence3))
	then
		stance = 1
		player.x = player.x + player.speed * 10 * dt
